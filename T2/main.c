...
int main()
{
    ...
    int vlr_saldo = 188600, qtd_abastecer, vlr_total = 0, vlr_saque, aux_saque;
    ...
    do
    {
        ...
        case 1://Cliente
            ...
            else
            {
                ...
                {
                    printf("Notas no caixa insuficientes para realizar este saque. Espere pelo abastecimento do caixa.\n");
                    break;
                }
                ...
                if(aux_saque > 0) //Se não conseguir notas para completar o saque
                printf("Notas no caixa insuficientes para realizar este saque. Espere pelo abastecimento do caixa.\n");
                else
                {
